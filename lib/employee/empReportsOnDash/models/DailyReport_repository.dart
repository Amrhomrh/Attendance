  ...
  Future<List<DailyReportsModel>> getDailyReports({
    ...
    if (kUseMockApi) {
      ...
      return [
        DailyReportsModel(
          payCode: 'EMP001',
          shiftStartTime: DateTime(now.year, now.month, now.day, 9, 0),
          shiftEndTime: DateTime(now.year, now.month, now.day, 17, 0),
          lunchStartTime: DateTime(now.year, now.month, now.day, 13, 0),
          lunchEndTime: DateTime(now.year, now.month, now.day, 13, 30),
          in1: DateTime(now.year, now.month, now.day, 9, 2),
          out2: DateTime(now.year, now.month, now.day, 17, 0),
          hoursWorked: 8,
          status: 'Present',
        ),
      ];
