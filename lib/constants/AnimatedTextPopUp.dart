...
void showCustomSuccessAlertEmployee(BuildContext context, String successMessage) {
  showCustomDialog(
    ...
    confirmText: '', // Set confirm button text to an empty string
...
void showCustomSuccessAlertEditEmployee(BuildContext context, String successMessage) {
  showCustomDialog(
    ...
    confirmText: 'Ok', // Set confirm button text to an empty string
...
void showCustomFailureAlert(BuildContext context, String errorMessage) {
  showCustomDialog(
    ...
    // borderRadius: 10.0,
    confirmButtonColor: Colors.transparent, // Set button color to transparent
    confirmText: '', // Set confirm button text to an empty string
  );
}
